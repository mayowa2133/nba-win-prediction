...
class RecommendationRecord(Base):
    ...
    likely_range_low: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    likely_range_high: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    likely_range_confidence: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    most_likely_milestone: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    most_likely_milestone_probability: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    milestone_probabilities_json: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSON, nullable=True)
